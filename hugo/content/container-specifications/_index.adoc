...
link:https://github.com/k1ng440/crunchy-containers/blob/master/conf/collect/queries.yml[here].
...
For a configuration examples, see  link:https://github.com/k1ng440/crunchy-containers/blob/master/conf/prometheus[here].
...
For a configuration examples, see  link:https://github.com/k1ng440/crunchy-containers/blob/master/conf/grafana/defaults.ini[here].
